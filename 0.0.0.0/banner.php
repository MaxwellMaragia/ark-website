		        ...
		        <div class="card">
		          ...
		          <div class="card-body">
				    ...
				    <?php } unset($_SESSION['response']); ?>
              	    <table id="table_banner" class="table table-bordered table-striped">
              	    	<thead>
		                <tr>
		                  <th>Image</th>
		                  <th>Title</th>
		                ...
		                <tbody>
		                 <?php
                          $banner = $db->get('tbl_banner');
                          foreach ($banner as $row)
                          {
                          	$id = $row['id'];
                          	?>
                            <tr>
                            <td><img src="<?php echo $row['image']; ?>" width="120"></td>
						      ...
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
					              ...
					              <div class="form-group">
					                ...
					                <input type="text" name="updatesubtitle" class="form-control" value="<?php echo $row['subtitle']; ?>">
					              </div>
					              <div class="form-group">
					                <label for="exampleInputFile">Image</label>
					                  <div class="custom-file">
					                      ...
					                      <img src="<?php echo $row['image']; ?>" width="120" class="img-thumbnail">
						      ...
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          <div class="alert alert-danger" role="alert">
				                    Confirm deleting this content ?
				                  </div>
					              <div class="form-group">
					              	<input type="hidden" name="deletekey" class="form-control" value="<?=$id?>">
					              	<input type="hidden" name="imagepath" value="<?=$row['image']?>">
					              </div>
						        </div>
						        <div class="modal-footer justify-content-between">
						          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
	    ...
	    <div class="modal-dialog modal-lg">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Sub Title</label>
                <input type="text" name="subtitle" id="title" class="form-control" placeholder="Sub title">
              </div>
	        </div>
	        <div class="modal-footer justify-content-between">
	          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
